...
public class IndustrialCrusherMenu extends AbstractContainerMenu {
    ...
    public final IndustrialCrusherBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public IndustrialCrusherMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public IndustrialCrusherMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.INDUSTRIAL_CRUSHER_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (IndustrialCrusherBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.INDUSTRIAL_CRUSHER.get());
    }
